        ...
        <div class="md:w-1/2 md:mx-auto">
            <div class="rounded shadow">
                <div class="font-medium text-lg text-teal-darker bg-teal p-3 rounded-t">
                    {{ __('Verify Your Submission for ' . $model) }}
                </div>
                <div class="bg-white p-3 rounded-b">
                    ...
                    <p class="text-grey-dark">
                        ...
                        {{ __('If you did not receive the email') }}, <a href="{{ route('email-verifiable.resend', ['model' => $model, 'id' => $id]) }}" class="no-underline hover:underline text-teal-darker">{{ __('click here to request another') }}</a>.
                    </p>
                </div>
            </div>
        </div>
